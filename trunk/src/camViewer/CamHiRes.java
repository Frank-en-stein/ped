...
class CamHiRes{
	...
	System.out.println("HiResCam init OK: " + camNo);
    }
	...
	//////// Augmented Reality initialization ///////////
	try {
	    Utils.convertARParam(parent, calibrationYAML, calibrationData, vw, vh);
	}catch (Exception e){
	    System.out.println("Conversion error. " + e);
	}
	...
	System.out.println("HiResCam init OK: " + videoFile);
    }
...
class PaperSheet{
	...
	img = new PImage(w, h, PConstants.RGB);
